...
plot_timeseries <- function(ho,
  ...
  if(FALSE){
    ...
    # Try it
    plot_timeseries(hoi)
    plot_timeseries(hoi, by_user = TRUE)

    plot_timeseries(hoi, type='sessions', unit = 'hours')
    plot_timeseries(hoi, type='sessions', unit = 'days')
    plot_timeseries(hoi, type='sessions', unit = 'weeks')

    plot_timeseries(hoi, type='sounds', unit = 'hours')
    plot_timeseries(hoi, type='sounds', unit = 'days')
    plot_timeseries(hoi, type='sounds', unit = 'days', by_user = TRUE)
    plot_timeseries(hoi, type='sounds', unit = 'weeks')

    plot_timeseries(hoi, type='coughs', unit = 'hours')
    plot_timeseries(hoi, type='coughs', unit = 'days')
    plot_timeseries(hoi, type='coughs', unit = 'days', by_user = TRUE)
    plot_timeseries(hoi, type='coughs', unit = 'weeks')
  }
