...
Comparing Hyfe performance to a groundtruth, such as a set of labeled detections, requires that the two sets of events are synchronized. Even if Hyfe's system time differs from the labeler's clock by a second or two, that offset can complicate
