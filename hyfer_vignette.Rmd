...
```{r, echo=TRUE, eval=TRUE, collapse=TRUE, warning=FALSE, message=FALSE, fig.width=6.5, fig.height=3.8}
plot_total(ho)
```
...
This function, like other `plot...()` functions in `hyfer`, allow you to return the dataset underlying the plot in addition to (or instead of) producing the plot. 

```{r, echo=TRUE, eval=TRUE, collapse=TRUE, warning=FALSE, message=FALSE, fig.width=6.5, fig.height=3.8}
plot_total(ho,unit='weeks', 
           type='coughs', 
           print_plot = FALSE, 
           return_data = TRUE)
```
